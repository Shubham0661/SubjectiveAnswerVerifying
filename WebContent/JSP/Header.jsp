            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p><i class="fa fa-phone-square"></i>  +91 7773998694</p></div>
                    </div>
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<%=request.getContextPath()%>/JSP/Homepage.jsp"><img src="<%=request.getContextPath()%>/JSP/l.jpg" alt="logo" width="50%"></a>
                </div>
